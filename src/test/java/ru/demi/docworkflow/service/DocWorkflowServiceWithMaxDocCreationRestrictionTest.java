...
@SpringBootTest(
    ...
    properties = {
        ...
        "app.restriction.maxDocCreations.value=1",
        "app.restriction.maxDocCreations.enabled=true",
        "app.restriction.maxParticipationBetweenCompanies.enabled=false"
    }
)
public class DocWorkflowServiceWithMaxDocCreationRestrictionTest {
    ...
    public void shouldSaveSuccessfully() throws InterruptedException {
        ...
        doc.setFirstSide(company1);
        doc.setSecondSide(company2);
        doc.setCreateDate(LocalDateTime.now().minus(Duration.ofMinutes(70)));
        docRepository.saveAndFlush(doc);
